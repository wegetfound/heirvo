...
const GUIDES: Guide[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    related: ["recover-files-scratched-dvd", "recover-unfinalized-dvd", "recover-video-from-camcorder-dvd", "caption-old-wedding-video-automatically", "searchable-family-video-archive-windows", "dvd-drive-freezing-mid-recovery-fix", "slim-vs-desktop-dvd-drive-recovery"],
    sections: [
      {
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    related: ["recover-files-scratched-dvd", "recover-data-cracked-dvd", "how-long-do-dvds-last-disc-rot", "dvd-drive-disconnects-mid-scan", "dvd-drive-freezing-mid-recovery-fix", "powered-usb-hub-dvd-recovery"],
    sections: [
      {
        id: "first-30-minutes",
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    related: ["recover-files-scratched-dvd", "recover-water-damaged-dvd", "dvd-drive-not-reading-disc-windows-11", "dvd-drive-freezing-mid-recovery-fix", "slim-vs-desktop-dvd-drive-recovery"],
    sections: [
      {
        id: "safety-warning",
